...
public class IO {
    ...
    public static String copyFile_char(final File fsrc) throws IOException {
        return io(new FileReader(fsrc));
    }

    public static String copyFile_byte(final File fsrc) throws IOException {
        return io(new FileInputStream(fsrc));
    }
